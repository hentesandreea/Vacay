            ...
            <ImageBackground source={image} resizeMode="cover" style={{ flex:1, justifyContent: 'center',alignItems:'center'}} blurRadius={2}>
                <View style={{borderRadius:10, backgroundColor:'#DCF2F1', padding:20, justifyContent:'center', width:'90%', alignItems:'center', shadowOpacity:0.3}}>
                    ...
                    <View style={{flexDirection:'row', gap: 3, alignItems:'center'}}>
                        <Text style={{color:'grey',fontSize:16, fontWeight:'500'}}>Do not have an account?</Text>
                        <TouchableOpacity onPress={() => navigator.navigate('Register')}>
                            <Text style={{fontSize:16, fontWeight:'600', textDecorationLine:'underline', color:'grey'}}>Register</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </ImageBackground>
